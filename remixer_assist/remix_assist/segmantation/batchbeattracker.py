...
from initremixer.segmentation.beattracker import estimate_beats_and_tempo
from infinitremixer.utils.io import load
...
class BatchBeatTracker:
    ...
    def _estimate_beat_and_tempo_for_file(self, file_path):
        ...
        beats, tempo = estimate_beats_and_tempo(signal, self.sample_rate)
